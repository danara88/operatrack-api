...
class OperationTest {
    ...
    void constructor_createsValidOperation() {
        ...
        Operation operation = new Operation(10, 150.0, 160.0, 1500.0, 50.0, 35.0, null, null, brokerageFirm);
    ...
    void constructor_acceptsZeroShareQuantity() {
        ...
        Operation operation = new Operation(0, 150.0, 150.0, 0.0, 0.0, null, null, null, brokerageFirm);
    ...
    void constructor_acceptsZeroPurchasePrice() {
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0);
        Operation operation = new Operation(10, 0.0, 0.0, 0.0, 0.0, null, null, null, brokerageFirm);
    ...
    void constructor_acceptsZeroTotalValue() {
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0);
        Operation operation = new Operation(0, 0.0, 0.0, 0.0, 0.0, null, null, null, brokerageFirm);
    ...
    void constructor_computesZeroPurchaseTaxWhenTaxRateIsZero() {
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0);
        Operation operation = new Operation(10, 150.0, 150.0, 1500.0, 0.0, null, null, null, brokerageFirm);
    ...
    void constructor_setsPurchaseDateToNow() {
        ...
        Operation operation = new Operation(10, 150.0, 150.0, 1500.0, 50.0, null, null, null, brokerageFirm);
    ...
    void constructor_throwsWhenShareQuantityIsNull() {
        ...
        InvalidShareQuantityException ex = assertThrows(InvalidShareQuantityException.class,
                () -> new Operation(null, 150.0, 150.0, 1500.0, 50.0, null, null, null, brokerageFirm));
    ...
    void constructor_throwsWhenShareQuantityIsNegative() {
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0035);
        InvalidShareQuantityException ex = assertThrows(InvalidShareQuantityException.class,
                () -> new Operation(-1, 150.0, 150.0, 1500.0, 50.0, null, null, null, brokerageFirm));
        assertEquals("Share quantity must be zero or a positive number.", ex.getMessage());
    }
    ...
    void constructor_throwsWhenPurchasePriceIsNull() {
        ...
        InvalidPurchasePriceException ex = assertThrows(InvalidPurchasePriceException.class,
                () -> new Operation(10, null, 150.0, 1500.0, 50.0, null, null, null, brokerageFirm));
    ...
    void constructor_throwsWhenPurchasePriceIsNegative() {
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0035);
        InvalidPurchasePriceException ex = assertThrows(InvalidPurchasePriceException.class,
                () -> new Operation(10, -1.0, 150.0, 1500.0, 50.0, null, null, null, brokerageFirm));
        assertEquals("Purchase price must be zero or a positive number.", ex.getMessage());
    }
    ...
    void constructor_throwsWhenTotalValueIsNull() {
        ...
        InvalidTotalValueException ex = assertThrows(InvalidTotalValueException.class,
                () -> new Operation(10, 150.0, 150.0, null, 50.0, null, null, null, brokerageFirm));
    ...
    void constructor_throwsWhenTotalValueIsNegative() {
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0035);
        InvalidTotalValueException ex = assertThrows(InvalidTotalValueException.class,
                () -> new Operation(10, 150.0, 150.0, -1.0, 50.0, null, null, null, brokerageFirm));
        assertEquals("Total value must be zero or a positive number.", ex.getMessage());
    }
    ...
    void constructorWithId_createsValidOperationWithProvidedId() {
        ...
        Operation operation = new Operation(providedId, 10, 150.0, 160.0, 1500.0, 50.0,
                35.0, purchaseDate, null, null, brokerageFirm);
    ...
    void constructorWithId_acceptsUUIDAsId() {
        ...
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0035);
        Operation operation = new Operation(providedId, 10, 150.0, 160.0, 1500.0, 50.0,
                null, Instant.now(), null, null, brokerageFirm);
        assertEquals(providedId, operation.getId());
    }
    ...
    void constructorWithId_assignsProvidedPurchaseDate() {
        ...
        Operation operation = new Operation("op-id", 10, 150.0, 160.0, 1500.0, 50.0,
                null, purchaseDate, null, null, brokerageFirm);
        assertEquals(purchaseDate, operation.getPurchaseDate());
    }
    ...
    void constructorWithId_computesTaxValuesFromTaxInstance() {
        BrokerageFirm brokerageFirm = new BrokerageFirm("BBVA", 0.0035);
        Operation operation = new Operation("op-id", 10, 150.0, 160.0, 1500.0, 50.0,
                35.0, Instant.now(), null, null, brokerageFirm);
        assertEquals(brokerageFirm.calculatePurchaseTax(10, 150.0), operation.getPurchaseTax(), 1e-9);
        assertEquals(brokerageFirm.calculateSaleTax(10, 160.0), operation.getSaleTax(), 1e-9);
        assertEquals(brokerageFirm.calculateTotalTax(10, 150.0, 160.0), operation.getTotalTax(), 1e-9);
    }
